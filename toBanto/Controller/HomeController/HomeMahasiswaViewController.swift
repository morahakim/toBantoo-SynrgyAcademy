...
class HomeMahasiswaViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var imgArr = [UIImage(named: "Image1"),
      ...
      var dataCampaign: [DataTableCampaign] = []
      ...
      func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        func dataHomeMahasiswa(){
          ApiManager.shareInstance.callingGetCreateCampaign { [self] (result) in
    ...
    extension HomeMahasiswaViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    extension HomeMahasiswaViewController: UICollectionViewDelegateFlowLayout {
